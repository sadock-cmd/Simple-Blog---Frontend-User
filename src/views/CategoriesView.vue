...
const editCategory = async (data) => {
  ...
  console.log('category name', editName.value);
...
<template>
  <MainLayout>
    ...
    <div class="container p-2 mx-auto sm:p-4 text-gray-100">
      ...
      <div class="flex items-center justify-center md:justify-between text-gray-900 min-w-full">
        <div>
          <h2 class="mb-4 text-2xl font-semibold leadi">Categories</h2>
        </div>
        <div>
          <button @click.prevent="toggleModal()"
            class="px-3 py-1 font-semibold rounded-md bg-violet-400 text-gray-900">Add Category</button>
        </div>
