...
export const blogStore = defineStore('blog', {
  ...
  actions: {
    async getCategories() {
        ...
        this.categories  = Object.values(response.data).reverse()
    ...
    async getCategoryPosts(categoryId) {
        ...
        this.categoryPosts  = Object.values(response.data).reverse()
      
    },

    async getPosts() {
        const response = await axios.get('/api/posts')
        this.posts  = Object.values(response.data).reverse()
